...
DAILY_LOSS_LIMIT = _config.get('DAILY_LOSS_LIMIT', 0.05)
MAX_POSITION_SIZE = _config.get('MAX_POSITION_SIZE', 0.4)
MAX_LEVERAGE = _config.get('MAX_LEVERAGE', 10)
POSITION_SIZE_MULTIPLIER = _config.get('POSITION_SIZE_MULTIPLIER', 0.8)
CIRCUIT_BREAKER_ENABLED = _config.get('CIRCUIT_BREAKER_ENABLED', True)
MAX_DAILY_TRADES = _config.get('MAX_DAILY_TRADES', 50)
RISK_FREE_RATE = _config.get('RISK_FREE_RATE', 0.02)
